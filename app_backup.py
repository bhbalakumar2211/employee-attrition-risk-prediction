...
st.set_page_config(page_title="Employee Attrition Risk Intelligence", layout="wide", page_icon="🏢")
...
st.markdown("Analyze workforce trends and identify employee attrition risk using Machine Learning.")
